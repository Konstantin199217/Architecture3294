...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-08-27T03:50:41.426283646Z[GMT]")

public class Cloud {
  @SerializedName("cloud_id")
  private String cloudId = null;

  @SerializedName("id-client")
   ...
   * @return cloudId
  **/
  @Schema(example = "ff05b315", description = "")
  ...
  **/
   ...
   * @return RAM
  **/
  @Schema(example = "128", required = true, description = "Объум оперативной памяти")
   ...
   * @return CPU
  **/
  @Schema(example = "6", required = true, description = "Колличество ядер процессора")
