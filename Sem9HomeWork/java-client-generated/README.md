...
- API version: 0.0.1
  - Build date: 2023-08-27T03:50:41.426283646Z[GMT]
...
------------ | ------------- | ------------- | -------------
*CloudsApi* | [**cencelCloudById**](docs/CloudsApi.md#cencelCloudById) | **DELETE** /clouds/{cloud_id} | Метод отмены заказа в облаке по ID
*CloudsApi* | [**createCloud**](docs/CloudsApi.md#createCloud) | **POST** /clouds | Создаем заказ в облаке
