...
public interface CloudsApi  {
    ...
    String OPERATION_ID_CENCELCLOUDBYID = "cencelCloudById";
    ...
    void cencelCloudById(RequestParameter body, ServiceRequest request, Handler<AsyncResult<ServiceResponse>> resultHandler);
